...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Requête pour insérer un nouveau projet dans la base de données
    $requete_insertion = "INSERT INTO projet (titre, description, nombre_actions_a_vendre, nombre_actions_vendus, prix_action, id_startuper) VALUES ('$titre', '$description', '$nombre_actions_a_vendre', '$nombre_actions_vendus', '$prix_action', '$id_startuper')";
    ...
    if (mysqli_query($connexion, $requete_insertion)) {
        ...
        echo "Erreur lors de l'ajout du projet: " . mysqli_error($connexion);
    }
      ...
      <div class="login-content">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          ...
          <div class="input-div pass">
            ...
            <div class="div">
              <h5>Nombre d'actions à vendre</h5>
              <input
                type="number"
                id="nombre_actions_a_vendre"
                name="nombre_actions_a_vendre"
                class="input"
                required
              />
            </div>
          ...
          <div class="input-div pass">
            ...
            <div class="div">
              <h5>Nombre d'actions vendues</h5>
              <input
                type="number"
                id="nombre_actions_vendus"
                name="nombre_actions_vendus"
                class="input"
                required
              />
            </div>
